class DepositSubscriber
  def after_create(object)
    ::Pusher["private-#{object.member.uid}"].trigger_async('deposits', { type: 'create', attributes: object.as_json })
  end
  ...
  def after_destroy(object_data)
    ::Pusher["private-#{object.member.uid}"].trigger_async('deposits', { type: 'destroy', id: object_data[:id] })
  end
