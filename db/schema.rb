...
ActiveRecord::Schema.define(version: 20180127163857) do
  ...
  add_index "accounts", ["member_id", "currency"], name: "index_accounts_on_member_id_and_currency", unique: true, using: :btree
